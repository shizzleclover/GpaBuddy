...
class _CgpaScreenState extends State<CgpaScreen> {
  ...
  void _addSemester(BuildContext context) {
    if (_currentSemesterCourses.isNotEmpty) {
      ...
      setState(() => _currentSemesterCourses = []);
    }
  }
            ...
            child: isWideScreen
                ? Row(
                    ...
                    children: [
                      ...
                      SizedBox(width: 20.w),
                      _buildRightPanel(cgpa, cgpaProvider),
                    ],
                  )
                : Column(
                    children: [
  ...
  Widget _buildLeftPanel() {
    return Column(
      ...
      children: [
        ...
        Expanded(
          child: ListView.builder(
            itemCount: Provider.of<CgpaCalcProvider>(context).semesters.length,
            itemBuilder: (context, index) {
              final semester = Provider.of<CgpaCalcProvider>(context).semesters[index];
              return ListTile(
  ...
  Widget _buildRightPanel(double cgpa, CgpaCalcProvider cgpaProvider) {
    return Container(
      width: 200.w,
